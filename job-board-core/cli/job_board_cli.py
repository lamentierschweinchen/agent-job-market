...
def call_endpoint(endpoint: str, pem: str, args: list[str], value: str | None, gas_limit: int, contract: str) -> None:
    if not contract:
        raise RuntimeError("Missing contract address. Set JOB_BOARD_ADDRESS or pass --contract")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="JobBoardCore CLI wrappers")
